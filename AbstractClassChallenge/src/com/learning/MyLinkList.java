...
public class MyLinkList implements NodeList {
    ...
    public boolean addItem(ListItem newItem) {
        ...
        while (currentItem != null) {
            ...
            if (comparison < 0) {
                ...
                // equal
                System.out.println(newItem.getCurrentValue() + " is already present, not added");
                return false;
            }
        }
        return false;
    ...
    public boolean removeItem(ListItem item) {
        if (item != null){
            System.out.println("deleting item " + item.getCurrentValue());
        }
    ...
    public void traverse(ListItem root) {
        ...
        while (root != null) {
            System.out.println(root.getCurrentValue());
            root = root.next();
        }
    }
}
